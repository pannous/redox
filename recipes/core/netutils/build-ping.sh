...
echo "=== Stripping ==="
llvm-strip -o /opt/other/redox/share/ping target/aarch64-unknown-redox-clif/release/ping
ls -la /opt/other/redox/share/ping
echo "Done - ping is at /opt/other/redox/share/ping"
